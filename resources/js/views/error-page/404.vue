    ...
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">
          Verifique que la URL que ingresó sea correcta. Por favor haga clic en
          el botón de abajo para volver a la página de inicio o enviar un
          informe de error.
        </div>
        <a href="/" class="bullshit__return-home">Ir al inicio</a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    message() {
      return 'Esta pagina no ha sido encontrada...';
    },
  },
};
</script>
