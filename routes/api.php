...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::apiResource('especialidades', 'especialidades\EspecialidadesController')->middleware('permission:'.Acl::PERMISSION_PERMISSION_MANAGE);
...
Route::get('/orders', function () {
    ...
    for ($rowIndex = 0; $rowIndex < $rowsNumber; $rowIndex++) {
        $row = [
            'order_no' => 'GiroNegocio' . mt_rand(1000000, 9999999),
            'price' => mt_rand(10000, 999999),
            'status' => Faker::randomInArray(['realizado', 'pendiente']),
        ];
